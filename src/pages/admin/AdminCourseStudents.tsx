...
import { useAdminCourseStudents } from '@/hooks/admin/useAdminCourseStudents';
import {
  Table,
  TableBody,
  TableCell,
...
const AdminCourseStudents: React.FC = () => {
  ...
  const { course, students, isLoading, filteredStudents, completedCount, inProgressCount, avgProgress } = useAdminCourseStudents({
    courseId,
    searchQuery,
  });
