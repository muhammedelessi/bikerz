                    ...
                    return (
                      <>
                        ...
                        <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-4">
                          {items.map((item) => (
                            <div key={item.id} className="flex items-start gap-3 p-4 rounded-xl bg-card border border-border/50 hover:border-primary/20 hover:shadow-sm transition-all">
