  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <main>
          ...
          <section className="relative overflow-hidden">
                ...
                <div className="w-full">
                  {previewVideoPlaying ? (
                    ...
                    >
                      <picture>
                        <source
                          srcSet={(course as any).preview_video_thumbnail || course.thumbnail_url || heroImage}
                          type="image/webp"
                        />
                        <img
            ...
            <div className="page-container relative z-10 pt-1 sm:pt-3 pb-6 lg:pb-16 px-4 sm:px-6">
              <Link
                to="/courses"
                className="inline-flex items-center text-muted-foreground hover:text-foreground transition-colors mb-1.5 lg:mb-4 text-xs sm:text-sm"
              >
                      ...
                      <div className="space-y-5">
                        <div className="text-center py-2">
                          {(() => {
                            ...
                            return (
                              <span className="text-4xl font-black text-foreground">
                                {course.price === 0 ? t("common.free") : `${priceInfo.finalPrice} ${sym}`}
                              </span>
                            );
                          })()}
                          {course.price > 0 && (
                            <p className="text-xs text-muted-foreground mt-1">{t("courseDetail.priceIncludesVAT")}</p>
                          )}
                        </div>
                        {course.price === 0 ? (
                          user ? (
      ...
      <div className="fixed bottom-20 end-4 z-50 lg:hidden">
        <Button size="sm" className="h-10 px-4 text-xs font-bold rounded-full shadow-lg" asChild>
          <Link to="/courses">
