...
const HondaApplication: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col" dir={isRTL ? 'rtl' : 'ltr'}>
      <Navbar />
      <main className="flex-1 max-w-2xl w-full mx-auto px-4 py-8 sm:py-12 space-y-6 pt-[calc(var(--navbar-h)+8rem)]">
        {/* Header */}
        <div className="text-center space-y-2">
          <img
            src={hondaLogo}
            alt="Honda"
            className="mx-auto h-20 sm:h-24 w-auto object-contain mb-3"
            loading="eager"
            decoding="async"
          />
