...
const WhatsAppFloatingButton: React.FC = () => {
  return (
    <a
      ...
      aria-label="WhatsApp"
      className="fixed z-50 flex h-14 w-14 items-center justify-center rounded-full shadow-lg transition-transform hover:scale-110 active:scale-95"
      style={{ backgroundColor: '#25D366', bottom: 'calc(env(safe-area-inset-bottom, 0px) + 24px)', right: '24px' }}
    >
