        ...
        <div className="group relative h-full rounded-2xl border border-border/60 bg-card/80 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-primary/50 hover:shadow-[0_8px_40px_hsl(var(--primary)/0.15)]">
          ...
          <div className="p-5 sm:p-6 flex flex-col gap-4">
            ...
            {isEnrolled && enrollment && (
              <div>
                <div className="flex items-center justify-between text-xs mb-1.5">
                  ...
                  <span
                    className={`font-semibold ${isCompleted ? "text-green-600 dark:text-green-400" : "text-primary"}`}
                  >
            ...
            {!isCompleted && (
              <div className="flex items-center justify-between">
                <div className="flex items-baseline gap-2">
                  <span className="text-2xl font-black text-primary">{priceInfo.finalPrice}</span>
                  <span className="text-sm font-semibold text-primary/70">{sym}</span>
                  {priceInfo.discountPct > 0 && (
            ...
            {isCompleted ? (
              ...
              <Button variant="default" className="w-full h-11 text-sm font-bold group/btn relative overflow-hidden">
