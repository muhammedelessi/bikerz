    ...
    <LazyMotion features={domAnimation} strict>
      <section className="relative min-h-[90svh] lg:min-h-[85svh] flex flex-col">
        ...
        {showStats && (
          ...
          >
            {/* الخط المتوهج العلوي - ألوانك الخاصة */}
            <div
            ...
            >
              <div className="max-w-[1200px] mx-auto px-4 py-6 md:py-8">
                {/* شبكة: 2 في الجوال و 4 في الكمبيوتر */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-y-8 gap-x-4">
                  {displayStats.map((stat, i) => {
                    // حل مشكلة Runtime Error: التأكد من أن الأيقونة ممررة كمكون
                    ...
                    return (
                      <m.div
                        ...
                        className="group flex items-center justify-start md:justify-center gap-3 sm:gap-4 px-2"
                      >
                        {/* دائرة الأيقونة - لون البرتقالي الخاص بك */}
                        <div
                          className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center border transition-transform duration-300 group-hover:scale-110"
                          style={{
                            backgroundColor: "hsl(18 78% 45% / 0.1)",
                            borderColor: "hsl(18 78% 45% / 0.3)",
                          }}
                        >
                          {Icon && <Icon size={22} style={{ color: "hsl(18 78% 45%)" }} />}
                        </div>

                        {/* النصوص */}
                        <div className="flex flex-col">
                          <span
                            className="text-lg sm:text-2xl font-black tabular-nums leading-none tracking-tight"
                            style={{
                              color: "hsl(18 78% 45%)",
                          ...
                          <span className="text-[10px] sm:text-[11px] font-semibold uppercase tracking-widest leading-tight mt-1 text-muted-foreground group-hover:text-foreground/70 transition-colors">
                            {stat.label}
                          </span>
                        </div>
                        ...
                        {i < displayStats.length - 1 && (
                          <div
                            className="hidden md:block absolute end-0 top-1/2 -translate-y-1/2 w-px h-10 opacity-20"
            ...
            {/* الخط المتوهج السفلي الأخضر - ألوانك الخاصة */}
            <div
