...
const MadaIcon = ({ className = 'h-5 w-auto' }: { className?: string }) => (
  <svg viewBox="0 0 796 266" className={className} style={{ direction: 'ltr' }}>
    <path d="M0 39.37C0 17.62 17.62 0 39.37 0h717.26C778.38 0 796 17.62 796 39.37v187.26c0 21.75-17.62 39.37-39.37 39.37H39.37C17.62 266 0 248.38 0 226.63V39.37z" fill="#1D3D71"/>
    <path d="M164.7 77.26h-36.24v111.48h36.24v-43.33h.5l38.46 43.33h43.5l-48.1-52.29 44.43-59h-41.75l-36.54 52.29h-.5V77.26z" fill="#fff"/>
    <path d="M297.47 77.26c-35.14 0-64.1 24.09-64.1 55.98 0 31.9 28.96 56.07 64.1 56.07 35.14 0 64.1-24.17 64.1-56.07 0-31.89-28.96-55.98-64.1-55.98zm0 82.01c-16.88 0-29.62-11.66-29.62-26.2 0-14.53 12.74-26.15 29.62-26.15 16.83 0 29.58 11.62 29.58 26.15 0 14.54-12.75 26.2-29.58 26.2z" fill="#fff"/>
    <path d="M396.45 77.26h-34.5v111.48h56.24c36.55 0 60.95-21.38 60.95-55.77 0-34.27-24.4-55.95-60.95-55.95h-21.74v.24zm0 82.01v-52.6h21.74c16.48 0 26.47 8.87 26.47 26.28 0 17.49-9.99 26.32-26.47 26.32h-21.74z" fill="#fff"/>
    <path d="M553.98 77.26h-34.5v111.48h34.5v-52.49" fill="#fff"/>
    <path d="M553.98 77.26h-34.5v29.7h34.5V77.26z" fill="#3FAE49"/>
    <path d="M611.34 77.26c-35.14 0-64.1 24.09-64.1 55.98 0 31.9 28.96 56.07 64.1 56.07 35.14 0 64.1-24.17 64.1-56.07 0-31.89-28.96-55.98-64.1-55.98zm0 82.01c-16.87 0-29.62-11.66-29.62-26.2 0-14.53 12.75-26.15 29.62-26.15 16.84 0 29.58 11.62 29.58 26.15 0 14.54-12.74 26.2-29.58 26.2z" fill="#fff"/>
  </svg>
);
