...
import {
  ...
  Loader2, XCircle, Pencil, X, User, Phone, MapPin,
} from 'lucide-react';
...
const CheckoutPaymentStep: React.FC<CheckoutPaymentStepProps> = memo(({
  ...
  fullName, setFullName, email,
  phone, setPhone, phonePrefix, setPhonePrefix, phonePrefixOptions,
  isOtherCountry, isOtherCity, countryManual, setCountryManual,
  country, setCountry, cityManual, setCityManual, city,
  countryOptions, cityOptions, selectedCountryCode,
  handleCountryChange, handleCityChange,
  errors, setErrors,
  courseTitle, courseTitleAr,
  paymentStatus, isPaymentReady, onSubmitPayment,
}) => {
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              {promoCode && !promoApplied && (
                <button type="button" onClick={() => setPromoCode('')}
            ...
            <Button variant="outline" size="default" onClick={handleApplyPromo}
          ...
          <div className="p-4 space-y-2.5">
            ...
            {displayPhone && (
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium font-mono" dir="ltr">{displayPhone}</span>
              </div>
            )}
        ...
        <div className="flex flex-col items-center gap-2 pt-2">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1 text-[10px] text-muted-foreground/60">
              <Shield className="w-3 h-3" /><span>3D Secure</span>
            </div>
            <span className="text-muted-foreground/20">|</span>
            <div className="flex items-center gap-1 text-[10px] text-muted-foreground/60">
              <Shield className="w-3 h-3" /><span>PCI DSS</span>
            </div>
          </div>
        </div>
      </motion.div>
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-1.5">
              ...
              {isOtherCountry && (
                <Input
                  value={countryManual}
                  onChange={(e) => { setCountryManual(e.target.value); setCountry(e.target.value); }}
