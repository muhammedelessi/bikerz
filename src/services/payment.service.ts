...
export async function createCharge(
  ...
  if (isBundleCharge) {
    ...
    const body = {
      ...
      billing_city: config.billingCity ?? null,
      billing_country: config.billingCountry ?? null,
      billingCity: config.billingCity ?? null,
      billingCountry: config.billingCountry ?? null,
